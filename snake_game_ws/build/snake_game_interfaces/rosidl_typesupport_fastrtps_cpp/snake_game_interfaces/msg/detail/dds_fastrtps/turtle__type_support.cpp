...
#include "snake_game_interfaces/msg/detail/turtle__rosidl_typesupport_fastrtps_cpp.hpp"
  ...
  size_t current_alignment)
{
  ...
  if (is_plain) {
    ...
    using DataType = snake_game_interfaces::msg::Turtle;
    is_plain =
      (
...
{
  auto typed_message =
    static_cast<const snake_game_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  auto typed_message =
    static_cast<snake_game_interfaces::msg::Turtle *>(
    untyped_ros_message);
...
{
  return &snake_game_interfaces::msg::typesupport_fastrtps_cpp::_Turtle__handle;
}
