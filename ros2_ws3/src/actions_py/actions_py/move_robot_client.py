...
class  MoveRobotClientNode(Node):
    def __init__(self):
        ...
        self.cancel_subscriber_ = self.create_subscription(Empty, "cancel_move", self.callback_cancel_move, 10)
    ...
    def goal_feedback_callback(self, feedback_msg):
        ...
        self.get_logger().info("Feedback position: "+str(current_position))
    ...
    def cancel_goal(self):
        if self.goal_handle_ is not None:
            self.get_logger().info("Send a cancel reqeuest")
            self.goal_handle_.cancel_goal_async()

    # To cancel
    # ros2 topic pub -1 /cancel_move example_interfaces/msg/Empty "{}"
