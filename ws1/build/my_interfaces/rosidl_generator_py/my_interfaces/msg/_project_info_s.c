...
bool my_interfaces__msg__project_info__convert_from_py(PyObject * _pymsg, void * _ros_message)
{
  // check that the passed message is of the expected Python class
  {
    ...
    assert(strncmp("my_interfaces.msg._project_info.ProjectInfo", full_classname_dest, 43) == 0);
  }
  my_interfaces__msg__ProjectInfo * ros_message = _ros_message;
  {  // id
...
{
  /* NOTE(esteve): Call constructor of ProjectInfo */
  PyObject * _pymessage = NULL;
  {
    PyObject * pymessage_module = PyImport_ImportModule("my_interfaces.msg._project_info");
    assert(pymessage_module);
    PyObject * pymessage_class = PyObject_GetAttrString(pymessage_module, "ProjectInfo");
