...
class Metaclass_SetLED(type):
    ...
    def __import_type_support__(cls):
        try:
            ...
            import traceback
            logger = logging.getLogger(
                'activity1_interfaces.srv.SetLED')
            logger.debug(
                'Failed to import needed modules for type support:\n' +
                traceback.format_exc())
        else:
            ...
            from activity1_interfaces.srv import _set_led
...
class SetLED(metaclass=Metaclass_SetLED):
    from activity1_interfaces.srv._set_led import SetLED_Request as Request
    from activity1_interfaces.srv._set_led import SetLED_Response as Response
